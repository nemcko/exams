...
@Component({
  selector: 'exasetusr',
  template: `
  <pgaddlg [title]="labels.addUserTitle+' ('+parentId+')'">
...
export class AddUserComponent {
  ...
  protected get qparams() {
    return { commandId: 'adduser', userId: this._parentId, examtype: this.parentQparams.examtype };
  }
  ...
  constructor(
    ...
    this.oid = 'exagrps/adduser';
    this.uuid = this._refrUuid = this._service.getUUID('exagrps/adduser%add');
