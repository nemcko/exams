...
import * as textdata from './examinations-dialog.component.json';
...
export class ExaminationsDialogComponent implements OnInit {
  private _id;
  ...
  constructor(
    ...
    this.labels = texts.toObject([textdata, examination, notifycation, panelbuttons, validators], _user.lng);
