...
import * as textdata from './state-e02.component.json';
...
@Component({
  selector: 'e02',
  templateUrl: './state-e02.component.html'
})
export class StateE02Component implements IExaCtrl, OnInit, OnDestroy {
  ...
  public initForm() {
    switch (this.cardcode) {
      case 'e02a': this.cardForm = this.fb.group({
        ...
        break;
      case 'e02b': this.cardForm = this.fb.group({
        ...
        break;
      case 'e02c': this.cardForm = this.fb.group({
        ...
        break;
      case 'e02d': this.cardForm = this.fb.group({
