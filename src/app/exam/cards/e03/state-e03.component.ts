...
import * as textdata from './state-e03.component.json';
...
@Component({
  selector: 'e03',
  templateUrl: './state-e03.component.html'
})
export class StateE03Component implements IExaCtrl, OnInit, OnDestroy {
  ...
  public initForm() {
    switch (this.cardcode) {
      case 'e03a': this.cardForm = this.fb.group({
