...
import * as textdata from './state-t01.component.json';
...
@Component({
  selector: 't01',
  templateUrl: './state-t01.component.html'
})
export class StateT01Component implements IExaCtrl, OnInit, OnDestroy {
  ...
  public initForm() {
    this.cardForm = this.fb.group({
      ...
      flyingrules: [this.data.flyingrules, [Validators.required, Validators.maxLength(3)]],
  ...
  public getData() {
    ...
    return {
      ...
      lng: formdata.lng,
      flyingrules: formdata.flyingrules,
